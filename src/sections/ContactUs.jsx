...
const ContactUs = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-gray-800 py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-6xl">
          ...
          {contacts.map((contact, index) => (
            ...
            >
              <div className="p-3 rounded-lg bg-gray-100 dark:bg-gray-700 inline-flex items-center justify-center">
                <span className="text-3xl text-gray-700 dark:text-gray-100">
                  {contact.icon}
                </span>
              </div>
              ...
              <h4
                ...
                className="font-bold text-gray-800 dark:text-white text-lg mt-4"
              >
                {contact.title}
              </h4>
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-sm py-8 px-6 text-center max-w-3xl mx-auto">
          ...
          <div className="flex justify-center gap-3 sm:gap-4 flex-wrap">
            <span className="px-4 py-1.5 bg-blue-100 text-blue-600 dark:bg-blue-900/40 dark:text-blue-300 rounded-full text-sm font-medium">
              Quick Response
            </span>
            <span className="px-4 py-1.5 bg-green-100 text-green-600 dark:bg-green-900/40 dark:text-green-300 rounded-full text-sm font-medium">
              Free Consultation
            </span>
            <span className="px-4 py-1.5 bg-purple-100 text-purple-600 dark:bg-purple-900/40 dark:text-purple-300 rounded-full text-sm font-medium">
              Flexible Schedule
            </span>
          </div>
        </div>
